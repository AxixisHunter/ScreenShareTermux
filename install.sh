...
echo -e "${BLUE}Setting up ScreenShare for Termux...${NC}\n"

# Install dependencies
echo -e "${GREEN}Installing required packages...${NC}"
pkg update -y
pkg install -y python adb scrcpy termux-api
...
echo -e "${BLUE}To use ScreenShare:${NC}"
echo -e "1. Connect your target Android device via OTG"
echo -e "2. Enable USB debugging on the target device"
echo -e "3. Run ${GREEN}screensh${NC} in Termux\n"
echo -e "Other commands:"
echo -e "${GREEN}screensh help${NC} - Show help information"
